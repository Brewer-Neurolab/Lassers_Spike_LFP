...
%% Create FID 5 G12 in variable
load("D:\Brewer lab data\Slow Oscillation 4 Chamber 5 Tunnel Arrays\4x 210715 210806\1\18-Apr-2023_A\4x 33152 210715 21div 210806_1_mat_files\G12.mat")
load("D:\Brewer lab data\Slow Oscillation 4 Chamber 5 Tunnel Arrays\4x 210715 210806\1\18-Apr-2023_A\4x 33152 210715 21div 210806_1_mat_files\times_G12.mat")
t=1/hp.Fs:1/hp.Fs:300;
mySpikeTimes=cluster_class(logical(cluster_class(:,1)),2)/1000;
spike_idx=find(ismembertol(t,mySpikeTimes,10^-10));

in.data_wb={data'};
in.trial_time={data'};
in.Spike_cell={spike_idx'};
in.Spike_trial=1;
