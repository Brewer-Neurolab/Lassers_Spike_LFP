...
data=load("D:\Brewer lab data\Slow Oscillation 4 Chamber 5 Tunnel Arrays\4x 210715 210806\1\downsampled tunnels\Theta\4x 24573 210715 21div 210806_1_mat_files\K6.mat");
re_fs=data.re_fs;
...
ax.FontSize=16;
%% Test function
targetElecs=well_spike_dyn.channel_name(well_spike_dyn.fi==3 & well_spike_dyn.regi==3);
MI_tbl=cummulative_axon_well_burst_start(t,re_t,logicalValidLFPs,LFPAmplitude,LFPAngles,3,"K6",targetElecs,well_spike_dyn,40,thresh_mult);
