...
MI_tbl=cummulative_axon_well_burst_start(t,re_t,logicalValidLFPs,LFPAmplitude,LFPAngles,6,"G12",targetElecs,well_spike_dyn,9);
%% scatter plot SPB vs Burst Length
scatter_BL_v_SPB(well_spike_dyn,MI_tbl(MI_tbl.pval<0.05,:))
...
burstIdx=ismembertol(well_burst_starts,find(logicalBurstStarts & logicalValidLFPs),1e-10);
burstIdx=find(burstIdx);
well_spb=well_spike_dyn.SpikeperBurst{well_spike_dyn.fi==6 & well_spike_dyn.channel_name=="A8"};
...
ax=gca;
ax.YScale="log";
%% 3D Graph of A8 spikes in bursts
